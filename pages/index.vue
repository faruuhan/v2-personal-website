<template>
  <div class="w-[1024px] mx-auto grid grid-cols-12 gap-6 pt-5">
    <div class="col-span-4">
      <h3 class="font-sans text-4xl text-black">{{ clock }}</h3>
      <h4 class="font-sans text-black">{{ today }}</h4>
    </div>
    ...
    <div class="col-span-4 row-span-2">
      <div class="relative overflow-hidden bg-white h-36 rounded-2xl">
        <img src="~/static/picture/indah.jpg" class="z-0 -mt-5" alt="" />
        <div
          class="absolute top-0 z-10 flex flex-col justify-end w-full h-full bg-zinc-950/40"
        >
          <div class="px-4 mb-4">
            <h6 class="font-sans text-lg font-medium text-white">
              Indah Cahya ❤️
            </h6>
            <div class="flex gap-2">
              ...
              <p class="font-sans text-white">on Instagram</p>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    today() {
      return dayjs(this.dateTime).format("dddd, MMMM YY");
    },
  },
};
</script>
